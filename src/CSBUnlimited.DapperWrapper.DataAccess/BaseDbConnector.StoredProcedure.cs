...
namespace CSBUnlimited.DapperWrapper
{
    public abstract partial class BaseDbConnector : IDbConnector
    {
        ...
        protected virtual void ExecuteNonQuery(string storedProcedureName, DynamicParameters parameters)
        {
            Connection.Execute(storedProcedureName, parameters, transaction: (Transaction?.Connection == null) ? null : Transaction, commandType: CommandType.StoredProcedure);
        }
        ...
        protected virtual IEnumerable<T> ExecuteQuery<T>(string storedProcedureName, DynamicParameters parameters)
        {
            return Connection.Query<T>(storedProcedureName, parameters, transaction: (Transaction?.Connection == null) ? null : Transaction, commandType: CommandType.StoredProcedure);
        }
        ...
        protected virtual T ExecuteSingleOrDefaultQuery<T>(string storedProcedureName, DynamicParameters parameters)
        {
            return Connection.QuerySingleOrDefault<T>(storedProcedureName, parameters, transaction: (Transaction?.Connection == null) ? null : Transaction, commandType: CommandType.StoredProcedure);
        }
        ...
        protected virtual GridReader ExecuteQueryMultiple(string storedProcedureName, DynamicParameters parameters)
        {
            return Connection.QueryMultiple(storedProcedureName, parameters, transaction: (Transaction?.Connection == null) ? null : Transaction, commandType: CommandType.StoredProcedure);
        }
        ...
        public virtual NonQueryReturnItem ExecuteNonQueryStoredProcedure(string storedProcedureName, IDbParameterList parametersCollection, bool isReturnValueExists = true)
        {
            ...
            ExecuteNonQuery(storedProcedureName, parameters);
        ...
        public virtual QueryReturnItem<T> ExecuteQueryStoredProcedure<T>(string storedProcedureName, IDbParameterList parametersCollection, bool isReturnValueExists = true)
        {
            ...
            returnItem.DataItemList = ExecuteQuery<T>(storedProcedureName, parameters);
        ...
        public virtual QuerySingleOrDefaultReturnItem<T> ExecuteQueryStoredProcedureSingleOrDefault<T>(string storedProcedureName, IDbParameterList parametersCollection, bool isReturnValueExists = true)
        {
            ...
            returnItem.DataItem = ExecuteSingleOrDefaultQuery<T>(storedProcedureName, parameters);
        ...
        public virtual QueryMultipleReturnItem ExecuteQueryMultipleStoredProcedure(string storedProcedureName, IDbParameterList parametersCollection, bool isReturnValueExists = true)
        {
            ...
            using (GridReader gridReader = ExecuteQueryMultiple(storedProcedureName, parameters))
            {
