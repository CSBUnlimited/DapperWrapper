...
{
    /// <summary>
    /// Use when execute query with nine queries from DB.
    /// </summary>
    ...
    public class QueryMultipleListsReturnItem<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TEighth, TNineth> : IReturnItem
    {
        /// <summary>
